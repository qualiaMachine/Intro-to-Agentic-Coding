...
|------|-------------|----------------|
| Cloud VM session (nothing local) | [claude.ai/code](https://claude.ai/code) | [github.com/copilot/agents](https://github.com/copilot/agents); assign an issue to Copilot |
| Read-only exploration / plan review | Plan mode (<kbd>Shift</kbd>+<kbd>Tab</kbd>) | Ask or Plan mode (chat mode dropdown) |
