...
| 0:15 | 12 | Words of caution: security, secrets, policies, trust | Episodes 2 & 8 |
| 0:27 | 8 | Exercise 1: first look at a repo (plan mode, read-only) | Episode 3 |
...
**Episode 7 (Common Workflows) in the 2-hour format:** async-only material. If time
...
**Episode 8 (Trust) in the 2-hour format:** there is no dedicated slot for the trust
